...
class CourseMainAdapter(private val courseList: List<Course>): RecyclerView.Adapter<CourseMainAdapter.CourseMainViewHodler>() {

    var onItemClick: ((CourseMainAdapter.Course) -> Unit)? = null
